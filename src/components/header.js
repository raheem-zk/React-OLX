    ...
    <div className="bg-gray-100">
      <div className="flex justify-between py-3 px-28">
        ...
        <div className="relative">
          <i class="fa-solid fa-magnifying-glass absolute top-2 left-3 transform translate-y-1/2"></i>
          <input
            disabled
            type="text"
            placeholder="india"
        ...
        <p className="font-bold mt-2 underline ml-7 cursor-pointer hover:no-underline">
          Login
        </p>
